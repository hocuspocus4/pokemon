...
-   We will be using the [Pokemon](https://github.com/rfordatascience/tidytuesday/blob/main/data/2025/2025-04-01/readme.md) dataset, which contains information about 949 pokemons on 22 variables.
...
-   We did a violin plot to compare the distribution of total stats between single and dual type pokemons. The plot shows that dual type pokemons have a higher median and a wider distribution of total stats compared to single type pokemons.

-   ***`total stats  = hp + attack + defense + special attack + special defense + speed`***
